        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtpLockoutEnd = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Fashion and apparel", true, "Clothing" },
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "CreatedDate", "Email", "FullName", "IsActive", "OtpAttemptCount", "OtpExpiryTime", "OtpLockoutEnd", "Password", "PasswordResetOtpHash", "PasswordResetToken", "ResetTokenExpiryTime", "Role" },
                values: new object[] { 1, new DateTime(2026, 1, 3, 23, 34, 29, 833, DateTimeKind.Local).AddTicks(1540), "admin@brandsstore.com", "Admin User", true, 0, null, null, "bP7YWvLCZQbJT2nKxQF0Dw==:qO9vEYH9nz4W3pJQQlXGzQ==", null, null, null, "Admin" });
